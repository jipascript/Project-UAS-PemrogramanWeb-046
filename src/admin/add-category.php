...
if ($_POST) {
    ...
    if (empty($errors)) {
        try {
            $query = "INSERT INTO categories (name, description, is_active, created_at, updated_at) 
                      VALUES (?, ?, ?, NOW(), NOW())";
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-center mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold font-heading">Tambah Kategori</h1>
            <p class="text-gray-600 mt-2">Buat kategori produk baru</p>
        </div>
    </div>
        ...
        <form method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                          placeholder="Deskripsi kategori..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
            </div>
